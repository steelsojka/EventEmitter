...
(function(h,a){var g=a.extend();g.register=function(c){var a=this,d={on:function(c,b,d,e){a.on.call(a,c,b,d||this,e)},emit:function(){a.emit.apply(a,arguments)},once:function(c,b,d){a.once.call(a,c,b,d)},off:function(c,b,d){a.off.call(a,c,b,d||this)}};d.addListener=d.on;d.removeListener=d.off;if("[object Array]"===Object.prototype.toString.apply(c))for(var e=c.length-1;0<=e;e--)b(c[e],d);else b(c,d);return this};a.prototype=g;var b=function(c,a){"function"===typeof c?c.prototype=e(c.prototype,a):
"object"===typeof c&&e(c,a)},e=function(a,b){for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);return a};h.EventEmitter=a})(this,EventEmitter);